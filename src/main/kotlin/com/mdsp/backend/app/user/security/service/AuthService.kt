...
class AuthService {
    ...
    fun authenticate(loginRequest: User, typeRequest: String = "default", withPassword: Boolean = true): Status {
        ...
        var userCandidate: Optional<Profile> = profileRepository.findByUsernameAndDeletedAtIsNull(loginRequest.getUsername()!!)
        println("userCandidate")
        if (!userCandidate.isPresent) {
            userCandidate = profileRepository.findByEmailIgnoreCaseAndDeletedAtIsNull(loginRequest.getUsername()!!)
        } else {
        ...
        println("!!userCandidate.isPresent")
        try {
