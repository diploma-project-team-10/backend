...
//        TODO myna jerde ozgertu kerek
        val expirationTime = if(username == newsUsername) 1000*1000 else 1000;
        return Jwts.builder()
                .setSubject(username)
                .setIssuedAt(Date())
                .setExpiration(Date((Date()).getTime() + jwtExpirationInMs!! * expirationTime))
