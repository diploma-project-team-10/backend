...
//        return ResponseEntity.ok("User registered successfully. Check your email for verification")
        ...
        val switchRequest = User()
        switchRequest.setUsername(registrationRequest.getEmail())
        switchRequest.setPassword(registrationRequest.getPassword())
        return ResponseEntity.ok(authService.authenticate(switchRequest,  "secret"))
    }
