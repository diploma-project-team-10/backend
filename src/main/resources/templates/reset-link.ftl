    ...
    <div class="main">
        ...
        <div class="section">
            <div class="menu">
                ...
                <span style="font-size: 18px">Please click the below button to change your password for <strong>Customer Engagement App</strong>.The link will be valid for next ${expirationTime} minutes.</span>
            </div>
            <div class="button">
                <table>
                    <tr>
                        <th style="width: 650px;"><a href="${userResetPasswordLink}" style="color: white; margin: auto">Reset Links</a></th>
                    </tr>
                </table>
            </div>
