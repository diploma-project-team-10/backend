<head>
    ...
    <#include "main-verification-reset-link.css">
</head>
<body style="background-color: #DCDCDC; height: 730px; padding: 30px">
<div class="content">
    <div class="main">
        <div class="header">
            <table>
        ...
        <div class="section">
            <div class="menu">
                ...
                <span style="font-size: 18px">Thank you for joining <strong>Customer Engagement App</strong>, an efficient and smart solution to manage your health!</span>
            </div>
            <p>To complete the registration process, please confirm your email address to activate your account</p>
            <button type="button">
                <a href="${userEmailTokenVerificationLink}" style="color: white;">Reset Links</a>
            </button>

            <p>Contact our support team if you have any questions or concerns. <a href="#" >Ask us any question</a></p>
